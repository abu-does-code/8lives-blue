...
const contractAddress = '0x82A85026859DD75c2b458b8474Aa7587BBD46769';
...
function getAllPatients(div_id) {

	let list_loading = document.getElementById("list-loading");

	web3.eth.net.isListening().then(async (s) => {
		console.log("Connected to node...");
		var test = await contract.methods.getAllPatients().call();
		console.log("test res",test)
		contract.methods.getAllPatients().call().then(function(count) {
...
function getAllDonors(div_id) {

	let list_loading = document.getElementById("list-loading");

	web3.eth.net.isListening().then(async (s) => {
		console.log("Connected to node... donor");
		console.log("Connected to TESTSTST... donor");

		
		contract.methods.getAllDonors().call().then(function(count) {
			list_loading.style.display = "none";
			 count=count.length;
